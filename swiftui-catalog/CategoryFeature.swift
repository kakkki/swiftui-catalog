...
let sampleCatalogCategories = [
    CatalogCategory(title: "Gesture Catalog", subtitle: "DragGesture, LongPressGesture etc...", text: "Using GestureState and updating method of the default Gesture Implementations and so on.", image: "Illustration 5")
]

//struct SampleFeatureContent: View {
//    var catalogCategory: CatalogCategory = sampleCatalogCategories[0]
//
//    var body: some View {
//        VStack(alignment: .leading, spacing: 8.0) {
